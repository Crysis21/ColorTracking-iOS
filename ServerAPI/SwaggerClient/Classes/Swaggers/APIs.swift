...
open class SwaggerClientAPI {
    open static var basePath = "http://eyecolor.us-east-2.elasticbeanstalk.com"
...
open class RequestBuilder<T> {
    ...
    open func processResponse<R>(response: DataResponse<R>, offlineRequest isOfflineRequest: Bool, completion: @escaping (Response<T>?, Error?) -> Void) -> Bool { return false }

    open func execute(offlineRequest isOfflineRequest: Bool = false, _ completion: @escaping (_ response: Response<T>?, _ error: Error?) -> Void) { }
